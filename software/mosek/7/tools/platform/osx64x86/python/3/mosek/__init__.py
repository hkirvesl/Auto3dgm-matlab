...
def _make_doublevector(v):
    ...
    if isinstance(v,numpy.ndarray):
        if v.ndim != 1:
            raise TypeAcceptError('Expected a 1-dimensional array')
        elif v.dtype.type is numpy.float64:
            return v
        else:
...
class Env:
  ...
  def __init__(self,licensefile=None,debugfile=None):
      ...
      debugfile = debugfile.encode('utf-8') if debugfile else None
      ...
      try:
          if licensefile is not None:
              licensefile = licensefile.encode('utf-8')
  ...
  def putlicensecode(self,code_):
    ...
    if code_ != None:
      if isinstance(code_, numpy.ndarray) and code_.dtype is numpy.int32 and code_.flags.contiguous:
        _code_copyarray = False
        _code_tmp = ctypes.cast(code_.ctypes._as_parameter_,ctypes.POINTER(ctypes.c_int32))
      elif isinstance(code_,array.ndarray) and code_.dtype is array.int32 and  code_.getsteplength() == 1:
        _code_copyarray = False
  ...
  def putlicensepath(self,licensepath_):
    ...
    putlicensepath(self,licensepath_)
      licensepath: str. A path specifycing where to search for the license.
    """
  ...
  def axpy(self,n_,alpha_,x_,y_):
    ...
    if x_ != None:
      if isinstance(x_, numpy.ndarray) and x_.dtype is numpy.float64 and x_.flags.contiguous:
        _x_copyarray = False
        _x_tmp = ctypes.cast(x_.ctypes._as_parameter_,ctypes.POINTER(ctypes.c_double))
      elif isinstance(x_,array.ndarray) and x_.dtype is array.float64 and  x_.getsteplength() == 1:
        _x_copyarray = False
  ...
  def gemv(self,transa_,m_,n_,alpha_,a_,x_,beta_,y_):
    ...
    if a_ != None:
      if isinstance(a_, numpy.ndarray) and a_.dtype is numpy.float64 and a_.flags.contiguous:
        _a_copyarray = False
        _a_tmp = ctypes.cast(a_.ctypes._as_parameter_,ctypes.POINTER(ctypes.c_double))
      elif isinstance(a_,array.ndarray) and a_.dtype is array.float64 and  a_.getsteplength() == 1:
        _a_copyarray = False
  ...
  def gemm(self,transa_,transb_,m_,n_,k_,alpha_,a_,b_,beta_,c_):
    ...
    if b_ != None:
      if isinstance(b_, numpy.ndarray) and b_.dtype is numpy.float64 and b_.flags.contiguous:
        _b_copyarray = False
        _b_tmp = ctypes.cast(b_.ctypes._as_parameter_,ctypes.POINTER(ctypes.c_double))
      elif isinstance(b_,array.ndarray) and b_.dtype is array.float64 and  b_.getsteplength() == 1:
        _b_copyarray = False
  ...
  def syeig(self,uplo_,n_,a_,w_):
    ...
    if w_ != None:
      if isinstance(w_, numpy.ndarray) and w_.dtype is numpy.float64 and w_.flags.contiguous:
        _w_copyarray = False
        _w_tmp = ctypes.cast(w_.ctypes._as_parameter_,ctypes.POINTER(ctypes.c_double))
      elif isinstance(w_,array.ndarray) and w_.dtype is array.float64 and  w_.getsteplength() == 1:
        _w_copyarray = False
...
class Task:
  ...
  def set_Progress(self,func):
      ...
      if func is None:
          ...
          self.__progress_func = weakref.ref(func)
  ...
  def set_Stream(self,whichstream,func):
      if isinstance(whichstream, streamtype):
          if func is None:
              ...
              self.__stream_func[whichstream] = weakref.ref(func)
  ...
  def removecons(self,subset_):
    ...
    if subset_ != None:
      if isinstance(subset_, numpy.ndarray) and subset_.dtype is numpy.int32 and subset_.flags.contiguous:
        _subset_copyarray = False
        _subset_tmp = ctypes.cast(subset_.ctypes._as_parameter_,ctypes.POINTER(ctypes.c_int32))
      elif isinstance(subset_,array.ndarray) and subset_.dtype is array.int32 and  subset_.getsteplength() == 1:
        _subset_copyarray = False
  ...
  def appendbarvars(self,dim_):
    ...
    if dim_ != None:
      if isinstance(dim_, numpy.ndarray) and dim_.dtype is numpy.int32 and dim_.flags.contiguous:
        _dim_copyarray = False
        _dim_tmp = ctypes.cast(dim_.ctypes._as_parameter_,ctypes.POINTER(ctypes.c_int32))
      elif isinstance(dim_,array.ndarray) and dim_.dtype is array.int32 and  dim_.getsteplength() == 1:
        _dim_copyarray = False
  ...
  def appendconesseq(self,conetype_,conepar_,nummem_,j_):
    ...
    _conetype_tmp_arr = array.array(conetype_,array.int32)
    _conetype_tmp = _conetype_tmp_arr.getdatacptr()
    if conepar_ is None:
      raise ValueError("Argument conepar cannot be None")
    if conepar_ is None:
      raise ValueError("Argument conepar may not be None")
    if conepar_ != None:
      if isinstance(conepar_, numpy.ndarray) and conepar_.dtype is numpy.float64 and conepar_.flags.contiguous:
        _conepar_copyarray = False
        _conepar_tmp = ctypes.cast(conepar_.ctypes._as_parameter_,ctypes.POINTER(ctypes.c_double))
      elif isinstance(conepar_,array.ndarray) and conepar_.dtype is array.float64 and  conepar_.getsteplength() == 1:
        _conepar_copyarray = False
    ...
    if nummem_ != None:
      if isinstance(nummem_, numpy.ndarray) and nummem_.dtype is numpy.int32 and nummem_.flags.contiguous:
        _nummem_copyarray = False
        _nummem_tmp = ctypes.cast(nummem_.ctypes._as_parameter_,ctypes.POINTER(ctypes.c_int32))
      elif isinstance(nummem_,array.ndarray) and nummem_.dtype is array.int32 and  nummem_.getsteplength() == 1:
        _nummem_copyarray = False
  ...
  def getacol(self,j_,subj_,valj_):
    ...
    if valj_ != None:
      if isinstance(valj_, numpy.ndarray) and valj_.dtype is numpy.float64 and valj_.flags.contiguous:
        _valj_copyarray = False
        _valj_tmp = ctypes.cast(valj_.ctypes._as_parameter_,ctypes.POINTER(ctypes.c_double))
      elif isinstance(valj_,array.ndarray) and valj_.dtype is array.float64 and  valj_.getsteplength() == 1:
        _valj_copyarray = False
  ...
  def getbarvarnameindex(self,somename_):
    ...
    getbarvarnameindex(self,somename_)
      somename: str. The requested name is copied to this buffer.
    returns: asgn,index
  ...
  def getbarxj(self,whichsol_,j_,barxj_):
    ...
    if barxj_ != None:
      if isinstance(barxj_, numpy.ndarray) and barxj_.dtype is numpy.float64 and barxj_.flags.contiguous:
        _barxj_copyarray = False
        _barxj_tmp = ctypes.cast(barxj_.ctypes._as_parameter_,ctypes.POINTER(ctypes.c_double))
      elif isinstance(barxj_,array.ndarray) and barxj_.dtype is array.float64 and  barxj_.getsteplength() == 1:
        _barxj_copyarray = False
  ...
  def getbarsj(self,whichsol_,j_,barsj_):
    ...
    if barsj_ != None:
      if isinstance(barsj_, numpy.ndarray) and barsj_.dtype is numpy.float64 and barsj_.flags.contiguous:
        _barsj_copyarray = False
        _barsj_tmp = ctypes.cast(barsj_.ctypes._as_parameter_,ctypes.POINTER(ctypes.c_double))
      elif isinstance(barsj_,array.ndarray) and barsj_.dtype is array.float64 and  barsj_.getsteplength() == 1:
        _barsj_copyarray = False
  ...
  def getpviolcon(self,whichsol_,sub_,viol_):
    ...
    if viol_ != None:
      if isinstance(viol_, numpy.ndarray) and viol_.dtype is numpy.float64 and viol_.flags.contiguous:
        _viol_copyarray = False
        _viol_tmp = ctypes.cast(viol_.ctypes._as_parameter_,ctypes.POINTER(ctypes.c_double))
      elif isinstance(viol_,array.ndarray) and viol_.dtype is array.float64 and  viol_.getsteplength() == 1:
        _viol_copyarray = False
  ...
  def gettaskname(self):
    ...
    res = __library__.MSK_XX_gettasknamelen(self.__nativep,0,ctypes.byref(__tmp_var_0),None)
    if res != 0:
      result,msg = self.__getlasterror(res)
      raise Error(rescode(result),msg)
  ...
  def putbaraij(self,i_,j_,sub_,weights_):
    ...
    if sub_ is None:
      raise ValueError("Argument sub may not be None")
    if sub_ != None:
      if isinstance(sub_, numpy.ndarray) and sub_.dtype is numpy.int64 and sub_.flags.contiguous:
        _sub_copyarray = False
        _sub_tmp = ctypes.cast(sub_.ctypes._as_parameter_,ctypes.POINTER(ctypes.c_int64))
      elif isinstance(sub_,array.ndarray) and sub_.dtype is array.int64 and  sub_.getsteplength() == 1:
        _sub_copyarray = False
        _sub_tmp = sub_.getdatacptr()
      else:
        _sub_copyarray = True
    ...
    if weights_ != None:
      if isinstance(weights_, numpy.ndarray) and weights_.dtype is numpy.float64 and weights_.flags.contiguous:
        _weights_copyarray = False
        _weights_tmp = ctypes.cast(weights_.ctypes._as_parameter_,ctypes.POINTER(ctypes.c_double))
      elif isinstance(weights_,array.ndarray) and weights_.dtype is array.float64 and  weights_.getsteplength() == 1:
        _weights_copyarray = False
  ...
  def getbarcsparsity(self,idxj_):
    ...
    if idxj_ != None:
      if isinstance(idxj_, numpy.ndarray) and idxj_.dtype is numpy.int64 and idxj_.flags.contiguous:
        _idxj_copyarray = False
        _idxj_tmp = ctypes.cast(idxj_.ctypes._as_parameter_,ctypes.POINTER(ctypes.c_int64))
      elif isinstance(idxj_,array.ndarray) and idxj_.dtype is array.int64 and  idxj_.getsteplength() == 1:
        _idxj_copyarray = False
  ...
  def getbarasparsity(self,idxij_):
    ...
    if idxij_ != None:
      if isinstance(idxij_, numpy.ndarray) and idxij_.dtype is numpy.int64 and idxij_.flags.contiguous:
        _idxij_copyarray = False
        _idxij_tmp = ctypes.cast(idxij_.ctypes._as_parameter_,ctypes.POINTER(ctypes.c_int64))
      elif isinstance(idxij_,array.ndarray) and idxij_.dtype is array.int64 and  idxij_.getsteplength() == 1:
        _idxij_copyarray = False
  ...
  def putbarcblocktriplet(self,num_,subj_,subk_,subl_,valjkl_):
    ...
    if subl_ != None:
      if isinstance(subl_, numpy.ndarray) and subl_.dtype is numpy.int32 and subl_.flags.contiguous:
        _subl_copyarray = False
        _subl_tmp = ctypes.cast(subl_.ctypes._as_parameter_,ctypes.POINTER(ctypes.c_int32))
      elif isinstance(subl_,array.ndarray) and subl_.dtype is array.int32 and  subl_.getsteplength() == 1:
        _subl_copyarray = False
    ...
    if valjkl_ != None:
      if isinstance(valjkl_, numpy.ndarray) and valjkl_.dtype is numpy.float64 and valjkl_.flags.contiguous:
        _valjkl_copyarray = False
        _valjkl_tmp = ctypes.cast(valjkl_.ctypes._as_parameter_,ctypes.POINTER(ctypes.c_double))
      elif isinstance(valjkl_,array.ndarray) and valjkl_.dtype is array.float64 and  valjkl_.getsteplength() == 1:
        _valjkl_copyarray = False
  ...
  def putbarablocktriplet(self,num_,subi_,subj_,subk_,subl_,valijkl_):
    ...
    if valijkl_ != None:
      if isinstance(valijkl_, numpy.ndarray) and valijkl_.dtype is numpy.float64 and valijkl_.flags.contiguous:
        _valijkl_copyarray = False
        _valijkl_tmp = ctypes.cast(valijkl_.ctypes._as_parameter_,ctypes.POINTER(ctypes.c_double))
      elif isinstance(valijkl_,array.ndarray) and valijkl_.dtype is array.float64 and  valijkl_.getsteplength() == 1:
        _valijkl_copyarray = False
  ...
  def putcslice(self,first_,last_,slice_):
    ...
    if slice_ != None:
      if isinstance(slice_, numpy.ndarray) and slice_.dtype is numpy.float64 and slice_.flags.contiguous:
        _slice_copyarray = False
        _slice_tmp = ctypes.cast(slice_.ctypes._as_parameter_,ctypes.POINTER(ctypes.c_double))
      elif isinstance(slice_,array.ndarray) and slice_.dtype is array.float64 and  slice_.getsteplength() == 1:
        _slice_copyarray = False
