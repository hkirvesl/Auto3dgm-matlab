...
echo ************************************************************************************* >> "%USERPROFILE%\moseklog.txt"
mosek -f -d MSK_IPAR_LICENSE_DEBUG MSK_ON "%MOSEK7_1_INSTALLDIR%\tools\examples\data\25fv47.mps" >>  "%USERPROFILE%\moseklog.txt"
echo ************************************************************************************* >> "%USERPROFILE%\moseklog.txt"
echo Test MIP.  >>  "%USERPROFILE%\moseklog.txt"
echo ************************************************************************************* >> "%USERPROFILE%\moseklog.txt"
mosek -f -d MSK_IPAR_LICENSE_DEBUG MSK_ON "%MOSEK7_1_INSTALLDIR%\tools\examples\data\flugpl.mps" >>  "%USERPROFILE%\moseklog.txt"
echo ************************************************************************************* >> "%USERPROFILE%\moseklog.txt"
...
type "%MOSEK7_1_INSTALLDIR%\mosek_license_install.log" >> "%USERPROFILE%\moseklog.txt"

echo ************************************************************************************* >> "%USERPROFILE%\moseklog.txt"
echo Current lmgrd: >>  "%USERPROFILE%\moseklog.txt"
type "%MOSEK7_1_INSTALLDIR%\lmgrd.log" >> "%USERPROFILE%\moseklog.txt"
